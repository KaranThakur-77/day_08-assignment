...
<body class="bg-indigo-300  font-serif  text-center my-8  ">
    ...
    <div class="container  grid lg:grid-cols-2 ml-24 ">
    <?php
        ...
        if($res->num_rows){
            while ($row=$res->fetch_assoc()) {
                ...
                <div class="h-80 w-80 my-8 flex px-8 ">
                   ...
                   <div class="ml-4 block text-justify bg-slate-50 py-4 my-8 border-solid border-2 rounded-xl pl-4 border-black pr-24 text-xl">
    ...
    <footer class="border-black rounded-2xl ml-80 mr-80 bg-slate-400 text-2xl font-serif cursor-pointer hover:text-cyan-800 transition font-bold text-gray-50 border-2 py-4">&copy;Copyright @ Karan Thakur</footer>
</body>
</html>